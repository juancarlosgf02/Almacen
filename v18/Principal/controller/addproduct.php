...
if(isset($_POST['code_cod'])		&& !empty($_POST['code_cod'])		&&
	...
	isset($_POST['nfactura'])		&& !empty($_POST['nfactura'])		&&
	isset($_POST['box_prod'])		&& !empty($_POST['box_prod'])		&&
	isset($_POST['location_box'])	&& !empty($_POST['location_box']))
{
	...
	$query = "INSERT INTO product(code_cod,size,box_prod,location_box,date_create,nfactura,proveedor) 	
		VALUES ('$code_cod','$size','$box_prod','$location_box','$date_create','$nfactura','$proveedor');";
