        ...
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            <li class="bold"><a class="collapsible-header  waves-effect waves-teal">INGRESO</a>
             ...
             <li class="bold"><a class="collapsible-header  waves-effect waves-teal">MODIFICAR CODIGO</a>
              <div class="collapsible-body">
                <ul>
            ...
            <li class="bold"><a class="collapsible-header  waves-effect waves-teal">EGRESO</a>
              <div class="collapsible-body">
                <ul>
            ...
            <li class="bold"><a class="collapsible-header  waves-effect waves-teal">Informe de Productos</a>
              <div class="collapsible-body">
                <ul>
                   <li><a href="#informacion">Informe de Producto</a></li>
                </ul>
              </div>
            </li>
...
<!-- ********************************* VISTA CELULAR **********************************  -->
      <ul id="nav-mobile" class="side-nav"><br/><br/>
          <li class="bold"><a href="#inicio" class="waves-effect waves-teal">Inicio</a></li>
              <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li class="bold"><a class="collapsible-header  waves-effect waves-teal">INGRESO</a>
