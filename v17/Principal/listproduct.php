        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="../princial.php#/distribucion">Distribución de Cajas</a></li>
                <li role="separator" class="divider"></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                  <li><a href="../principal.php#/modifystock">Egreso</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                  <li><a href="../principal.php#/informacion">Informe de Productos</a></li>
              </ul>
            </li>
          </ul>
...
<div class="container">
    ...
    <a href="../principal.php#/inicio"><button type="button" class="btn btn-info">Atras</button></a>
...
function Buscar(){
    ...
    product.location_box,product.date_create,product.proveedor
      FROM 
