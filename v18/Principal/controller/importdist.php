         ...
         if(strtolower(end($chk_ext)) == "csv"){
             ...
             while (($data = fgetcsv($handle, 1000, ",")) !== FALSE){
               //Insertamos los datos con los valores...
                //$sql = "INSERT into code (code_cod, description_cod, stock) 
                $sql = "INSERT into product (code_cod, box_prod, size,location_box,date_create,nfactura,proveedor)
            ...
            echo '<h4 class="text-center">Archivo Válido</h4>';
